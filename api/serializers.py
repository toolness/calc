...
class ContractSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Contract
        fields = ('id', 'idv_piid', 'vendor_name', 'labor_category', 'education_level', 'min_years_experience', 'current_price', 'next_year_price', 'second_year_price', 'schedule', 'contractor_site', 'business_size')
